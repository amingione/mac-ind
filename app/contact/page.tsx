...
export default function ContactPage() {
  ...
  const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
    e.preventDefault()
    // TODO: wire to API route or form service (Netlify Forms, Formspree, etc.)
    setSubmitted(true)
  }
      ...
      <section className="pt-36 pb-16 bg-mac-dark relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center gap-3 mb-4">
            ...
            <span className="text-mac-red text-xs uppercase tracking-widest">Contact</span>
          </div>
          ...
          <p className="text-gray-400 text-lg max-w-xl">
            Tell us about your project. We&apos;ll get back to you fast — and if it&apos;s
            an emergency, call directly.
          </p>
        </div>
      </section>
            ...
            <div className="space-y-8">
              ...
              <div className="bg-mac-gray border border-mac-gray-light rounded-xl p-6">
                ...
                <div className="mb-5">
                  ...
                  <p className="text-gray-500 text-xs mt-0.5 uppercase tracking-wide">{contact.title}</p>
                </div>
              ...
              <div className="bg-mac-red/10 border border-mac-red/30 rounded-xl p-6">
                <div className="flex items-center gap-2 mb-3">
                  <svg className="w-4 h-4 text-mac-red" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M1 21h22L12 2 1 21zm12-3h-2v-2h2v2zm0-4h-2v-4h2v4z" />
                  </svg>
                  <p className="text-mac-red text-xs font-bold uppercase tracking-widest">Emergency?</p>
                </div>
                <p className="text-gray-300 text-sm mb-3">
                  For forced outages and critical failures, call directly — 24/7.
                </p>
                <a
                  href={`tel:${contact.phone}`}
              ...
              {submitted ? (
                <div className="bg-mac-gray border border-mac-red/30 rounded-xl p-12 text-center">
                  <div className="w-16 h-16 rounded-full bg-mac-red/10 border border-mac-red/30 flex items-center justify-center mx-auto mb-6">
                    <svg className="w-8 h-8 text-mac-red" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2}>
                      <path strokeLinecap="round" strokeLinejoin="round" d="M4.5 12.75l6 6 9-13.5" />
                    </svg>
                  </div>
                  <h2 className="text-white text-2xl font-bold mb-3">Message Received</h2>
                  <p className="text-gray-400 mb-6">
                    We&apos;ll get back to you within 1 business hour. For urgent matters,
                    call Jayr directly at {contact.phone}.
                  </p>
                  <button
                ...
                <div className="bg-mac-gray border border-mac-gray-light rounded-xl p-8">
                  <div className="flex items-center gap-3 mb-8">
                    <div className="w-px h-7 bg-mac-red" />
                    <h2 className="text-white font-bold text-xl">Request a Quote</h2>
                  </div>

                  <form onSubmit={handleSubmit} className="space-y-5">
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                      <div>
                        <label className="block text-gray-400 text-xs uppercase tracking-wider mb-2" htmlFor="name">
                      ...
                      <div>
                        <label className="block text-gray-400 text-xs uppercase tracking-wider mb-2" htmlFor="company">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                      <div>
                        <label className="block text-gray-400 text-xs uppercase tracking-wider mb-2" htmlFor="email">
                      ...
                      <div>
                        <label className="block text-gray-400 text-xs uppercase tracking-wider mb-2" htmlFor="phone">
                          Phone
                        </label>
                        <input
                          id="phone"
                    ...
                    <div>
                      <label className="block text-gray-400 text-xs uppercase tracking-wider mb-2" htmlFor="service">
                        Service Needed
                      </label>
                      <select
                        id="service"
                    ...
                    <div>
                      <label className="block text-gray-400 text-xs uppercase tracking-wider mb-2" htmlFor="message">
